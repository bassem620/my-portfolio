        ...
        <Col sm={12} md={6} lg={4} className="boxesContainer">
            <div className="box">
                ...
                <div className="btns d-flex align-items-center">
                    <Btn toLink={project?.links?.linkedin} text="More" logo={<OpenInNewOutlinedIcon />} classes={"w-50 me-1 " + (!project.links.linkedin && "disable")}/>
                    <Btn toLink={project?.links?.github} text={project.private ? "Private" : "Code"} logo={<GitHubLogo />} classes={"w-50 ms-1 " + (!project.links.github && "disable")}/>
                </div>
            </div>
        </Col>
    )
